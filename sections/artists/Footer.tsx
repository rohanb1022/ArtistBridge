...
const Footer = () => {
  return (
    <footer className="py-10 px-4 text-center text-neutral-550 text-sm bg-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-medium mb-4 text-neutral-900">
        ...
        {/* <Link href="/artist/register">
          <Button className="bg-pink-600 hover:bg-pink-700 rounded-full text-neutral-900 px-6 py-4 text-base sm:text-lg">
      ...
      <div className="my-10 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-left text-sm">
        <div>
          ...
          <p className="mt-2 text-neutral-550">
        ...
        <div>
          ...
          <div className="flex gap-4 text-xl text-neutral-700">
